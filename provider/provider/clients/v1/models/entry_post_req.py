...
class EntryPostReq(BaseModel):
    """
    EntryPostReq
    """ # noqa: E501
    entry: Optional[EntryBody] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntryPostReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntryPostReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entry": EntryBody.from_dict(obj["entry"]) if obj.get("entry") is not None else None
        })
        return _obj
