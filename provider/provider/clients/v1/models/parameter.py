...
class Parameter(BaseModel):
    ...
    initial: Optional[StrictStr] = Field(default=None, description="The initial value of the parameter")
    required: Optional[StrictBool] = Field(default=None, description="Whether the parameter is required")
    description: Optional[StrictStr] = Field(default=None, description="The description of the parameter")
    __properties: ClassVar[List[str]] = ["name", "initial", "required", "description"]
